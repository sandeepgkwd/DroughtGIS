...
<html lang="en">
  <head>
    ...
    <title>Change password - Dashboard Drought Assessment System</title>
...
<link href='http://fonts.googleapis.com/css?family=Duru+Sans' rel='stylesheet' type='text/css'>
  ...
  <div class="container"> 
            ...
            =====================================================================================-->
             ...
             <div class="col-md-9" >
							<legend><span class="glyphicon glyphicon-lock fa-2x"></span>&nbsp;Change password</legend>
					...
					<form class="form-horizontal"  method="POST">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-4">
							  <input id="textinput" name="cpass" placeholder=" Password is here" class="form-control input-md" required="" type="password">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-4">
							  <input id="textinput" name="newpass" placeholder=" Password is here" class="form-control input-md" required="" type="password">
							  <span class="help-block">Retype your password</span>  
							  </div>
							</div>
							<!-- Text input-->
							<div class="form-group">
							  <label class="col-md-4 control-label" for="textinput">Password again</label>  
							  <div class="col-md-4">
							  <input id="textinput" name="newpass1" placeholder=" Password is here" class="form-control input-md" required="" type="password">
							  <span class="help-block">Type your password</span>  
							  </div>
							</div>
							<!-- Textarea -->
